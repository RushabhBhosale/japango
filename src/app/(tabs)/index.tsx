  ...
  return (
    <ScreenContainer>
      ...
      <View style={styles.section}>
        ...
        />
        <ActivityRow icon="checkmark-done-outline" label="Daily homework" detail="A 5–10 minute plan shaped by your progress and conversation practice" onPress={() => router.push('/homework' as Href)} />
